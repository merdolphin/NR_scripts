...
cat PDBs | sed -n ''$t2'p'  | while read x; do cd $x; pwd; cd dock_prot_mol2; cp /home/zhaol/scratch/NRs/10NRs/docking-script-crystalLigands.sh . ; ./docking-script-crystalLigands.sh ; done
