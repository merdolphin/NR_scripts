...
cat PDBs | sed -n ''$t2'p'  | while read x; do cd $x; pwd; cd dock_prot_mol2_2; cp /home/zhaol/scratch/NRs/10NRs/docking-script-ligands.sh . ; ./docking-script-ligands.sh ; done
